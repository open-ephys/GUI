...
#ifndef SPIKEDETECTCANVAS_H_
#define SPIKEDETECTCANVAS_H_
...
class SpikeDetectCanvas : public Visualizer, public Button::Listener

{
public:
    SpikeDetectCanvas(SpikeDetector* n);
    ~SpikeDetectCanvas();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SpikeDetectCanvas);
...
{
public:
    SpikeThresholdDisplay(SpikeDetector *, SpikeDetectCanvas*, Viewport*);
...
{
public:
    PCAProjectionAxes(SpikeDetector *p);
    ~PCAProjectionAxes() {}
